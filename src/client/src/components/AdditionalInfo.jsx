...
const AdditionalInfo = ({ currentPeak }) => {
    return (
        ...
        <div className="additional-info white-text">
            ...
            <p>While this guide provides some weather and trail information, it's crucial to consult external sources to safely plan your trip. Please read this <SafetyDisclaimerLink />.</p>
