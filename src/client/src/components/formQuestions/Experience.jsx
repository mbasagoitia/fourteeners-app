...
function Experience ({responses, setResponses, step, setStep, loggedIn}) {
    return (
    <>
    ...
    {parseInt(responses.experience) !== 1 ? (
        ...
        className="mt-4"
        type="checkbox"
        label={loggedIn ? "Only show me peaks that I have not hiked before" : (
            <span>Only show me peaks that I have not hiked before (you must <Link to={"#"}>log in</Link> for this feature)</span>
        )}
