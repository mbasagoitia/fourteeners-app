  ...
  return (
      ...
      <Card.Body>
        ...
        {editMode ? (
          ...
          <Button onClick={() => setPhotoUploadShown(true)} className="add-photos-btn"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="mb-1" viewBox="0 0 16 16">
