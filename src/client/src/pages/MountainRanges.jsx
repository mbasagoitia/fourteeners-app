    ...
    return (
        ...
        <Row className="ss-row">
            ...
            <div className="overlay-container">
                    <div className="form-overlay-box mountain-ranges">
                        <Row className="mb-4">
                            <Col>
                            <h1>Mountain Ranges of Colorado</h1>
                            </Col>
                        </Row>
                        <Row className="py-4" id="sawatch">
                            <Col md={6}>
                            <h2>Sawatch Range</h2>
                        ...
                        <Row className="py-4" id="mosquito">
                            <Col md={{span: 6, order: "last" }}>
